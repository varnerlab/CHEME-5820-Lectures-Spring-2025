...
Today, we take a different perspective: let's let the data tell us which should be grouped and what combinations of features are most (or least) important using eigendecomposition.

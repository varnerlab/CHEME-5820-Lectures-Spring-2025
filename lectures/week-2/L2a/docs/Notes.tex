...
in the context of unsupervised machine learning. Eigendecomposition gives us a way to decompose a matrix into its constituent parts,
...
Eigenvectors are special vectors that, when transformed by a matrix, do not change their direction; they are merely scaled by a corresponding eigenvalue. 

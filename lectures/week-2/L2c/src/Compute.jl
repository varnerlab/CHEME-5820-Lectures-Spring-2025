...
function _outer(a::Array{Float64,1}, b::Array{Float64,1})::Array{Float64,2}
...
"""
    outer(a::Array{Float64,1},b::Array{Float64,1}) -> Array{Float64,2}
...
"""
outer(a::Array{<:Number,1}, b::Array{<:Number,1}) = _outer(a,b);
